...
@router.post("/send", response_model=ChatBotResponse, status_code=status.HTTP_201_CREATED)
...
async def get_chat_history(
    ...
    limit: int = Query(50, ge=1, le=100, description="Nombre max de messages à retourner"),
