...
class ChatRepository:
    ...
    def create_chat_message(
        self, user_id: str, message_data: ChatMessageCreate, sender: str = "user", mood_detected: Optional[str] = None
    ) -> ChatHistory:
        ...
        db_message = ChatHistory(
            ...
            collected=True  # Par défaut, collecté si l'utilisateur a donné son consentement
        )
    ...
    def get_user_chat_stats(self, user_id: str, days: int = 7) -> dict:
        ...
        messages = self.get_user_chat_history_by_date_range(user_id, start_date, end_date)
